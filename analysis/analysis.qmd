...
for path in [RAW, PROCESSED, DOCS, FIGURES, REPORT_FIGURES, ROOT / "tmp" / "matplotlib"]:
...
"""
(DOCS / "style.css").write_text(style_css.strip() + "\n", encoding="utf-8")
...
"""
(DOCS / "viz.html").write_text(viz_html, encoding="utf-8")
